...
void getAQI() {
  ...
  if (PM25_Ip != 999999999 && PM10_Ip != 999999999 && CO2_Ip != 999999999 && TVOC_Ip != 999999999) {
    ...
    Serial.print("Pollutant Values: "); Serial.print(massConcentrationPm2p5); Serial.print(", "); Serial.print(massConcentrationPm10p0); Serial.print(", "); Serial.print(CO2); Serial.print(", "); Serial.println(TVOC);
